...
namespace Isaac_SAP_ProjectAssignment {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AccountsRow AddAccountsRow(string Username, string Password, string Number, bool IsAdmin) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string Number {
                get {
                    return ((string)(this[this.tableAccounts.NumberColumn]));
                }
                set {
                    this[this.tableAccounts.NumberColumn] = value;
                }
            }
...
namespace Isaac_SAP_ProjectAssignment.Database1DataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Accounts] WHERE (([Id] = @Original_Id) AND ([Username] = @Orig" +
                "inal_Username) AND ([Password] = @Original_Password) AND ([Number] = @Original_N" +
                "umber) AND ([IsAdmin] = @Original_IsAdmin))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Accounts] ([Username], [Password], [Number], [IsAdmin]) VALUES" +
                " (@Username, @Password, @Number, @IsAdmin);\r\nSELECT Id, Username, Password, Numb" +
                "er, IsAdmin FROM Accounts WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Accounts] SET [Username] = @Username, [Password] = @Password, [Number] = @Number, [IsAdmin] = @IsAdmin WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Number] = @Original_Number) AND ([IsAdmin] = @Original_IsAdmin));
SELECT Id, Username, Password, Number, IsAdmin FROM Accounts WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Isaac_SAP_ProjectAssignment.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, Number, IsAdmin FROM dbo.Accounts";
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Password, string Original_Number, bool Original_IsAdmin) {
        ...
        public virtual int Insert(string Username, string Password, string Number, bool IsAdmin) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Number, bool IsAdmin, int Original_Id, string Original_Username, string Original_Password, string Original_Number, bool Original_IsAdmin, int Id) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string Number, bool IsAdmin, int Original_Id, string Original_Username, string Original_Password, string Original_Number, bool Original_IsAdmin) {
            return this.Update(Username, Password, Number, IsAdmin, Original_Id, Original_Username, Original_Password, Original_Number, Original_IsAdmin, Original_Id);
        }
    }
